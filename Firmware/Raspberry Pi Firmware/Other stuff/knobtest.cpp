...
unsigned long long currentTimeMillis()
{
    ...
    return (unsigned long long)(currentTime.tv_sec) * 1000 + (unsigned long long)(currentTime.tv_usec) / 1000;
}
...
int main(int argc, char** argv)
{
    ...
    printf("Timestamp       Delta %4s   %4s    %4s    %4s\n", "A0", "A1", "A2", "A3");
    ...
    while (true) {
        ...
        printf("%lld %7d %12.2f %12.2f %12.2f %12.2f\r", now, elapsed, volts[0], volts[1], volts[2], volts[3]);
